...
--
-- Host: localhost    Database: arkphp
-- ------------------------------------------------------
...
CREATE TABLE `ark_user` (
  `id_ark_user` int(11) DEFAULT NULL PRIMARY KEY AUTO_INCREMENT,
...
INSERT INTO `ark_user` VALUES ('0','arkphp','e10adc3949ba59abbe56e057f20f883e','admin');
...
-- Dump completed on 2016-10-27 16:25:45
