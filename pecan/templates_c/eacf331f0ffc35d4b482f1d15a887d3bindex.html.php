				...
				<section class="content">
					<div class='row'>
						<div class="col-md-9">
							...
							<?php foreach ($this->_vars['postlist'] as $key=>$value) { ?> 

							<div class="box box-success post-box">
								<div class="box-header with-border">
									<h2 class="box-title"><?php echo $value['title']?></h2>
								</div>
								<!-- /.box-header -->
								<div class="box-body">
									...
									<div class="post type-post appeared">
										...
										<div class="post-info">
											...
											<span class="author">作者: <a itemprop="name" href="/1/"
												rel="author">ark1ee</a></span>

											<!-- 分类页面category不显示 -->

											<span class="category">分类: <a href=""></a> <?php echo $value['category']?>
											</span> <span class="date">时间:<?php echo $value['pubtime']?></span> <span
												class="date">浏览:   <?php echo $value['view']?>次 </span>
										...
										<p class="more">
												<a href="<?php echo $this->_config['ACTION_URL'];?>/index/show_post?id=<?php echo $value['id_ark_post']?>">阅读全文»</a>
											</p>
									</div>
								</div>
								...
								<div class="box-body no-padding">
									<ul class="nav nav-pills nav-stacked">
										<li><a href="mailbox.html"><i class="fa fa-inbox"></i>
												默认分类 <span class="label label-success pull-right">12</span></a></li>
